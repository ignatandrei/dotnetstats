...
public class StatsServiceQuozd : IProjectService
{
    private readonly HttpClient httpClient;
    public StatsServiceQuozd(HttpClient httpClient)
    {
    ...
    {
        var url = "https://raw.githubusercontent.com/quozd/awesome-dotnet/refs/heads/master/README.md";
